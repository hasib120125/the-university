...
class SubjectAssignmentController extends Controller
{
    ...
    public function store(Request $request, Subject $subject)
    {
        ...
        $data['attachment1_original_filename'] = $request->file('attachment1') ? $request->file('attachment1')->getClientOriginalName() : null;
        $data['attachment2_original_filename'] = $request->file('attachment2') ? $request->file('attachment2')->getClientOriginalName() : null;
    ...
    public function update(Request $request, Subject $subject, SubjectAssignment $assignment)
    {
        ...
        $assignment->attachment1_original_filename = $request->file('attachment1') ? $request->file('attachment1')->getClientOriginalName() : $assignment->attachment1_original_filename;
        $assignment->attachment2_original_filename = $request->file('attachment2') ? $request->file('attachment2')->getClientOriginalName() : $assignment->attachment2_original_filename;
        $assignment->save();
