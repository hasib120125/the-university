    ...
    <div>
        <div class="row">
            <div class="col_12">
                <div class="card">
                    <div class="card-body">
                        <router-link :to="{ name: 'grade_system_add' }" class="btn btn_info">{{ trans('admin.form.grade_system.grade_system_add') }}</router-link>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col_12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">{{ trans('admin.form.grade_system.grade_system') }}</div>
                    </div>
                    <div class="card-body">
                        <table-component api-url="/api/admin/grade-systems"
                                         :fields="fields"
                                         ref="tableComponent"
    ...
    data() {
        return {
            fields: [
                {
                    name: 'from',
                    title: this.trans('admin.form.grade_system.from'),
                    sortField: 'from',
                    searchable: true
                },
                {
                    name: 'to',
                    title: this.trans('admin.form.grade_system.to'),
                    sortField: 'to',
                    searchable: true
                },
                {
                    name: 'grade',
                    title: this.trans('admin.form.grade_system.grade'),
                    sortField: 'grade',
                    searchable: true
                },
                {
                    name: 'point',
                    title: this.trans('admin.form.grade_system.point'),
                    sortField: 'point',
                    searchable: true
                },
                {
        ...
        deleteItem(item) {
            this.$swal({
                ...
                if (result.isConfirmed) {
                    axios.delete('/api/admin/grade-systems/'+item.id).then(() => {
