                    ...
                    <div class="row">
                        <div class="col_12">
                            <div class="form-group">
                                <label>{{ trans('admin.form.bulk_upload.video') }}</label>
    ...
    data(){
        return {
            ...
            dropzoneVideoOptions: {
                url: '/api/admin/upload/video/temp',
                addRemoveLinks: true,
                maxFilesize: 5120,
                thumbnailHeight: 120,
                timeout: 9999990000,
    ...
    methods: {
        ...
        cancelFile(file, error, xhr){
            ...
            if(this.$refs.fileDropzone.dropzone.disabled !== true){
                axios.post('/api/admin/bulk/video-file/delete', {deleteFile}).then((response) => {
                    this.$swal.fire(
        ...
        submitForm(){
            ...
            axios.post('/api/admin/bulk/video-file/upload', this.form)
                .then((response) => {
                    this.$router.push({name: 'bulk_video_list'});
                })
