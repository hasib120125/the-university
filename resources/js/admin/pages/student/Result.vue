                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title d_flex_btwn width_full">
                            <span v-if="student">{{ student.name }} - {{ trans('common.index.result') }}</span>
                            <router-link class="btn btn_secondary mr_5" :to="{name: 'all_students'}">{{ trans('common.index.back') }}</router-link>
                        </div>
                    </div>
...
export default {
    ...
    created(){
        axios.get('/api/admin/students/'+ this.$route.params.student_id)
                    .then((response) => {
    ...
    methods: {
        getData(){
            axios.get('/api/admin/student-result/'+ this.$route.params.student_id)
                    .then((response) => {
