    ...
    <div>
        <div class="row">
            <div class="col_12">
                <div class="card">
                    <div class="card-body">
                        <router-link :to="{ name: 'lecture_assignment_add' }" class="btn btn_info">{{ trans('admin.form.assignment.add_new_assignment') }}</router-link>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col_12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table-component :api-url="`/api/admin/lectures/${$route.params.id}/assignments`"
                                         :fields="fields"
                                         ref="tableComponent"
                    ...
                    data: [
                        {
                            ...
                            route: 'lecture_assignment_submitted',
                        ...
                        },
                        {
                            ...
                            route: 'lecture_assignment_update',
                            params: {assignment_id: 'id'}
                        },
                        {
        ...
        deleteItem(item) {
            this.$swal({
                ...
                if (result.isConfirmed) {
                    axios.delete(`/api/admin/lectures/${item.lecture_id}/assignments/${item.id}`).then(() => {
