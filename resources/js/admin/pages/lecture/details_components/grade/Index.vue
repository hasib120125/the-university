                ...
                <div :class="['card-body', {'loading_overlay': loading}]">
                    <div class="d_flex_inline mb_15">
                        ...
                        <select class="form_global mr_10" v-model="search.grade">
                            <option value="">--{{ trans('admin.form.grade_input.grade') }}--</option>
                    ...
                    <table class="table table_bordered table_fixed" :class="{'table_center': activeStudents.length > 0}">
                        <thead>
                            <tr>
                                ...
                                <th>{{ trans('admin.form.grade_input.student_id') }}</th>
...
export default {
    ...
    methods:{
        getActiveStudent(){
            axios.get(`/api/admin/lectures/${this.$route.params.id}/grades`,{
                    params: this.search
                })
                .then((response) => {
        ...
        submitForm(){
            ...
            axios.post('/api/admin/lectures/' + this.$route.params.id + '/grades', formData)
                .then((response) => {
                    this.$swal.fire(
