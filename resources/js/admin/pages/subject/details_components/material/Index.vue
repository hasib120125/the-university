    ...
    <div>
        <div class="row">
            <div class="col_12">
                <div class="card">
                    <div class="card-body">
                        <router-link :to="{ name: 'subject_material_add' }" class="btn btn_info">{{ trans('admin.form.lecture_material.add_new_material') }}</router-link>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col_12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table-component :api-url="`/api/admin/subjects/${$route.params.id}/materials?semester_id=${$route.params.semester_id}`"
                                         :fields="fields"
                                         ref="tableComponent"
        ...
        deleteItem(item) {
            this.$swal({
                ...
                if (result.isConfirmed) {
                    axios.delete(`/api/admin/subjects/${item.subject_id}/materials/${item.id}`).then(() => {
