            ...
            <div class="card">
                ...
                <div :class="['card-body', {'loading_overlay': loading}]" >
                            ...
                            <tr>
                                ...
                                <td colspan="7">
                                    <div class="row">
                                        <div class="col_4">
                                            <div class="form_row_inline">
                                                <label>{{ trans('admin.form.subject.attendance') }}</label>
                                        ...
                                        <div class="col_4">
                                            <div class="form_row_inline">
                                                <label>{{ trans('admin.form.subject.mid') }}</label>
                                        ...
                                        <div class="col_4">
                                            <div class="form_row_inline">
                                                <label>{{ trans('admin.form.subject.final') }}</label>
                                    ...
                                    <div class="row mt_10">
                                        <div class="col_4">
                                            <div class="form_row_inline">
                                                <label>{{ trans('admin.form.subject.others') }}</label>
                                        ...
                                        <div class="col_4">
                                            <div class="form_row_inline">
                                                <p>{{ trans('admin.form.subject.total') }}: <span :class="totalMark > 100 || totalMark < 100 ? 'color_danger' : ''">{{ totalMark > 0 ? totalMark: 0 }} %</span></p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="d_flex_end">
                        <router-link class="btn btn_secondary mr_5" :to="{name: 'subject_plan', params:{semester_id: $route.params.semester_id}}">{{ trans('admin.label.cancel') }}</router-link>
        ...
        axios.get('/api/admin/subjects/' + this.$route.params.id + '/plans/' + this.$route.params.semester_id)
            .then((response) => {
                if(response.data.data){
                    ...
                    if(this.subject_plan.subject_plan_topics.length == 0){
                        this.subject_plan.subject_plan_topics = [{subject_plan_id : null, date : '', topic : '', remark : '' }]
                    }
                }
            })
    },
    ...
    methods: {
        ...
        submitForm(){
            ...
            if(this.subject_plan.id){
                ...
                axios.patch('/api/admin/subjects/'+ this.$route.params.id + '/subject-plans/' + this.subject_plan.id, this.subject_plan)
                    .then((response) => {
                ...
                axios.post('/api/admin/subjects/'+ this.$route.params.id + '/subject-plans', this.subject_plan)
                    .then((response) => {
                        this.$router.push({name: 'subject_plan'});
                    })
                    .catch((err) => this.errors = err.response.data.errors)
