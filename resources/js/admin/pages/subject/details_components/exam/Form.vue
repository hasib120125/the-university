                    ...
                    <div class="row">
                        <div class="col_8">
                            <div class="form-group ">
                                <label>{{ trans('admin.form.exam.title') }}</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col_4">
                            ...
                            <div class="form_radio">
                                <input type="radio" id="status_1" name="radio" v-model="exam.status" value="1">
                                <label for="status_1">{{ trans('common.index.active') }}</label>
                            </div>
                            <div class="form_radio">
                                <input type="radio" id="status_0" name="radio" v-model="exam.status" value="0">
            ...
            <div class="card" v-for="(question, questionIndex) in exam.questions" :key="'question_' + questionIndex">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col_6">
                            ...
                            <div class="form_radio">
                                ...
                                <label :for="'ox_type' + questionIndex">{{ trans('admin.form.exam.question.ox_type') }}</label>
                            </div>
                            <div class="form_radio">
                                ...
                                <label :for="'multiple_choice' + questionIndex">{{ trans('admin.form.exam.question.mcq') }}</label>
                            </div>
                            <div class="form_radio">
                                ...
                                <label :for="'short_answer' + questionIndex">{{ trans('admin.form.exam.question.short') }}</label>
                            </div>
                            <div class="form_radio">
                                ...
                                <label :for="'narrative' + questionIndex">{{ trans('admin.form.exam.question.narrative') }}</label>
                            </div>
                            <v-errors :errors="errorFor('questions.'+ questionIndex +'.question_type')"></v-errors>
                        </div>
                        <div class="col_6">
                            <div class="form-group">
                                <label>{{ trans('admin.form.exam.question.difficulty') }} <small class="ml_5 color_danger"> {{ trans('admin.form.exam.question.dif_message') }}</small></label>
                    ...
                    <div class="row">
                        <div class="col_7">
                            <div class="form-group ">
                                <label>{{ trans('admin.form.exam.question.title') }}</label>
                        ...
                        <div class="col_5">
                            <div class="form-group ">
                                <label>{{ trans('admin.form.exam.question.new_marks') }}</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="d_flex_inline col_6">
                                        ...
                                        <input type="text" class="form_global" v-model="exam.questions[questionIndex].mcq1" placeholder="a">
                                    ...
                                    <div class="d_flex_inline col_6">
                                        ...
                                        <input type="text" class="form_global" v-model="exam.questions[questionIndex].mcq2" placeholder="b">
                                ...
                                <div class="row mt_10">
                                    <div class="d_flex_inline col_6">
                                        ...
                                        <input type="text" class="form_global" v-model="exam.questions[questionIndex].mcq3" placeholder="c">
                                    ...
                                    <div class="d_flex_inline col_6">
                                        ...
                                        <input type="text" class="form_global" v-model="exam.questions[questionIndex].mcq4" placeholder="d">
                                ...
                                <div class="row mt_10">
                                    <div class="d_flex_inline col_6">
                                        ...
                                        <input type="text" class="form_global" v-model="exam.questions[questionIndex].mcq5" placeholder="e">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d_flex_end">
                        <router-link class="btn btn_secondary mr_5" :to="{name: 'subject_exams', params: {semester_id: $route.params.semester_id }}">{{ trans('admin.label.cancel') }}</router-link>
...
export default {
    ...
    created() {
        if (this.$route.name === 'subject_exam_update') {
            ...
            axios.get('/api/admin/subjects/' + this.$route.params.id + '/exams/'+ this.$route.params.exam_id)
                .then((response) => {
    ...
    methods: {
        ...
        submitForm(){
            ...
            if (this.$route.name === 'subject_exam_update') {
                ...
                axios.patch('/api/admin/subjects/' + this.$route.params.id + '/exams/'+ this.$route.params.exam_id, this.exam)
                    .then((response) => {
                ...
                axios.post('/api/admin/subjects/' + this.$route.params.id + '/exams', this.exam)
                    .then((response) => {
                        this.$router.push({name: 'subject_exams', params: {semester_id: this.$route.params.semester_id }});
                    })
                    .catch((err) => this.errors = err.response.data.errors)
