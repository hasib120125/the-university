        ...
        <div class="row">
            <div class="col_12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table-component :api-url="`/api/admin/subjects/assignments/${$route.params.assignment_id}/students`"
                                         :fields="fields"
                                         ref="tableComponent"
                    ...
                    data: [
                        {
                            ...
                            action: 'approve',
                            condition: ['admin_action_button_show', true]
                        },
                        {
    ...
    methods: {
        ...
        approve(submittedAssignment) {
            this.$swal({
                ...
                if (result.isConfirmed) {
                    axios.post(`/api/admin/subjects/assignments/${this.$route.params.assignment_id}/students/${submittedAssignment.student.id}/approveOrReject`,{status: 1}).then(() => {
        ...
        reject(submittedAssignment) {
            this.$swal({
                ...
                if (result.isConfirmed) {
                    axios.post(`/api/admin/subjects/assignments/${this.$route.params.assignment_id}/students/${submittedAssignment.student.id}/approveOrReject`,{status: 2}).then(() => {
                        this.$refs.tableComponent.refresh();
                        this.$swal.fire(
