		...
		<div class="row">
			<div class="col_12">
				<div class="card">
					<div class="card-body">
						<router-link
							:to="{ name: 'ministry_of_ministry_add' }"
							class="btn btn_info"
							>{{
								trans("admin.form.ministry_of_ministry.add_new")
							}}</router-link
						>
					</div>
				</div>
				...
				<div class="card">
					<div class="card-header">
						<div class="card-title">
							{{
								trans(
									"admin.form.ministry_of_ministry.ministry_of_ministry"
								)
							}}
						</div>
					</div>
					<div class="card-body">
						<table-component
							api-url="/api/admin/ministry-of-ministry"
							:fields="fields"
							ref="tableComponent"
						...
						data: [
							{
								...
								route: "ministry_of_ministry_edit",
								params: { id: "id" },
							},
							{
			...
			deleteItem(item) {
				this.$swal({
					...
					if (result.isConfirmed) {
						axios
							.delete("/api/admin/ministry-of-ministry/" + item.id)
							.then(() => {
