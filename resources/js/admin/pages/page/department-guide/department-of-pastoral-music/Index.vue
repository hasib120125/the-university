		...
		<div class="row">
			<div class="col_12">
				<div class="card">
					<div class="card-body">
						<router-link
							:to="{ name: 'department_of_pastoral_music_add' }"
							class="btn btn_info"
							>{{
								trans(
				...
				<div class="card">
					<div class="card-header">
						<div class="card-title">
							{{
								trans(
									"admin.form.department_of_pastoral_music.department_of_pastoral_music"
								)
							}}
						</div>
					</div>
					<div class="card-body">
						<table-component
							api-url="/api/admin/department-of-pastoral-music"
							:fields="fields"
							ref="tableComponent"
						...
						data: [
							{
								...
								route: "department_of_pastoral_music_edit",
								params: { id: "id" },
							},
							{
			...
			deleteItem(item) {
				this.$swal({
					...
					if (result.isConfirmed) {
						axios
							.delete(
								"/api/admin/department-of-pastoral-music/" + item.id
							)
							.then(() => {
