				...
				<div class="card">
					<div class="card-header">
						<div class="card-title">
							{{
								trans(
									"admin.form.offline_seminar.offline_seminar"
								)
							}}
						</div>
					</div>
					<div class="card-body">
						<table-component
							api-url="/api/admin/offline-seminars"
							:fields="fields"
							ref="tableComponent"
				...
				fields: [
					{
						name: "title_en",
						title: this.trans(
							"admin.form.offline_seminar.title_en"
						),
						sortField: "title",
						searchable: true,
					},
					{
						name: "title_ko",
						title: this.trans(
							"admin.form.offline_seminar.title_ko"
						),
						sortField: "title",
						searchable: true,
					},
			...
			deleteItem(item) {
				this.$swal({
					...
					if (result.isConfirmed) {
						axios
							.delete("/api/admin/offline-seminars/" + item.id)
							.then(() => {
