    ...
    <div>
        <div class="row">
            <div class="col_12">
                <div class="card">
                    <div class="card-body">
                        <router-link :to="{ name: 'department_add' }" class="btn btn_info">{{ trans('admin.form.department.add_new_department') }}</router-link>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col_12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">{{ trans('admin.form.department.department') }}</div>
                    </div>
                    <div class="card-body">
                        <table-component api-url="/api/admin/departments"
                                         :fields="fields"
                                         ref="tableComponent"
    ...
    data() {
        return {
            fields: [
                {
                    name: 'name',
                    title: this.trans('admin.form.department.name'),
                    sortField: 'name',
                    searchable: true
                },
                {
                    name: 'code',
                    title: this.trans('admin.form.department.code'),
                    sortField: 'code',
                    searchable: true
                },
                {
                    name: 'degree',
                    title: this.trans('admin.form.department.degree'),
                    sortField: 'degree',
                    searchable: true
                },
                {
        ...
        deleteItem(item) {
            this.$swal({
                ...
                if (result.isConfirmed) {
                    axios.delete('/api/admin/departments/'+item.id).then(() => {
