            ...
            <div class="col_12">
                <div class="card">
                    <div class="card-header">
                        <div class="col_10">
                            <div class="card-title">{{ trans('professor.form.exam.student.student_list') }}</div>
                        </div>
                        <div class="col_2">
                            <div class="d_flex_end">
                                <router-link class="btn btn_sm btn_secondary mr_5" :to="{name: 'subject_exams'}"> {{ trans('common.index.back') }} </router-link>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <table-component :api-url="`/api/professor/subjects/exams/${$route.params.exam_id}/students`"
                                         :fields="fields"
                                         ref="tableComponent"
                    ...
                    data: [
                        {
                            ...
                            title: this.trans('professor.form.exam.student.exam_evaluate'),
                            route: 'subject_exam_evaluate',
