            ...
            <div class="card">
                ...
                <div :class="['card-body', {'loading_overlay': loading}]">
                    <div class="row">
                        <div class="col_12">
                            <div class="form-group ">
                                <label>{{ trans('professor.form.lecture_material.title') }}</label>
                        ...
                        <div class="col_12">
                            <div class="form-group ">
                                <label>{{ trans('professor.form.lecture_material.description') }}</label>
                        ...
                        <div class="col_6">
                            <div class="form-group">
                                <label>{{ trans('professor.form.lecture_material.attachment_1') }}</label>
                        ...
                        <div class="col_6">
                            <div class="form-group">
                                <label>{{ trans('professor.form.lecture_material.attachment_2') }}</label>
                                <div class="file_input">
                    ...
                    <div class="d_flex_end">
                        <router-link class="btn btn_secondary mr_5" :to="{name: 'subject_materials', params: {semester_id: $route.params.semester_id}}">{{ trans('professor.label.cancel') }}</router-link>
...
export default {
    ...
    data(){
        return {
            ...
            loading: false,
            pageName: this.trans('professor.form.lecture_material.add_new_material'),
        }
    },
    created() {
        ...
        if (this.$route.name === 'subject_material_update') {
            this.pageName = this.trans('professor.form.lecture_material.edit_materials');
            this.loading = true;
    ...
    methods: {
        submitForm(){
            ...
            if (this.$route.name === 'lecture_material_update') {
                ...
                axios.post('/api/professor/subjects/' + this.$route.params.id + '/materials/'+ this.$route.params.material_id, formData)
                    .then((response) => {
                        this.$router.push({name: 'subject_materials', params: {semester_id: this.$route.params.semester_id}});
                    })
                    .catch((err) => this.errors = err.response.data.errors)
                    .finally(() => this.loading = false);

            }else{
                axios.post('/api/professor/subjects/' + this.$route.params.id + '/materials', formData)
                    .then((response) => {
                        this.$router.push({name: 'subject_materials', params: {semester_id: this.$route.params.semester_id}});
                    })
                    .catch((err) => this.errors = err.response.data.errors)
