            ...
            <div class="card">
                ...
                <div :class="['card-body', {'loading_overlay': loading}]">
                    <div class="row">
                        <div class="col_12">
                            <div class="form-group ">
                                <label>{{ trans('professor.form.notices.title') }}</label>
                        ...
                        <div class="col_12">
                            <div class="form-group ">
                                <label>{{ trans('professor.form.notices.description') }}</label>
                        ...
                        <div class="col_6">
                            <div class="form-group">
                                <label>{{ trans('professor.form.notices.attachment_1') }}</label>
                        ...
                        <div class="col_6">
                            <div class="form-group">
                                <label>{{ trans('professor.form.notices.attachment_2') }}</label>
                                <div class="file_input">
                    ...
                    <div class="d_flex_end">
                        <router-link class="btn btn_secondary mr_5" :to="{name: 'subject_notices'}">{{ trans('professor.label.cancel') }}</router-link>
...
export default {
    ...
    data(){
        return {
            ...
            pageName: this.trans('professor.form.notices.add_new_notice'),
    ...
    created() {
        ...
        if (this.$route.name === 'subject_notice_update') {
            this.loading = true;
            this.pageName = this.trans('professor.form.notices.edit_notices');
    ...
    methods: {
        submitForm(){
            ...
            if (this.$route.name === 'subject_notice_update') {
                ...
                axios.post('/api/professor/subjects/' + this.$route.params.id + '/notices/'+ this.$route.params.notice_id, formData)
                    .then((response) => {
                ...
                axios.post('/api/professor/subjects/' + this.$route.params.id + '/notices', formData)
                    .then((response) => {
                        this.$router.push({name: 'subject_notices', params: {semester_id: this.$route.params.semester_id}});
                    })
                    .catch((err) => this.errors = err.response.data.errors)
