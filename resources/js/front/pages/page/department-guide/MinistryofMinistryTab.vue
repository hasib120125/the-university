				...
				<ul class="nav nav-tabs" id="myTab_2" role="tablist">
					...
					>
						<a
							...
							:id="'bellow_' + ministryOfMinistryIndex"
							data-toggle="tab"
							:href="'#bellow_' + ministryOfMinistryIndex + '-tab'"
							role="tab"
							:aria-controls="'bellow_' + ministryOfMinistryIndex"
							aria-selected="true"
				...
				<div class="tab-content" id="myTabContent">
					...
					>
						<div
							...
							:class="{ ' active': ministryOfMinistryIndex == 0 }"
							:id="'bellow_' + ministryOfMinistryIndex + '-tab'"
							role="tabpanel"
							:aria-labelledby="
								'bellow_' + ministryOfMinistryIndex
							"
							:key="
