				...
				<ul class="nav nav-tabs" id="myTab" role="tablist">
					...
					>
						<a
							...
							:id="'above_' + departmentOfPastoralMusicIndex"
							data-toggle="tab"
							:href="'#above_' + departmentOfPastoralMusicIndex + '-tab'"
							role="tab"
							:aria-controls="'above_' + departmentOfPastoralMusicIndex"
							aria-selected="true"
				...
				<div class="tab-content" id="myTabContent">
					...
					>
						<div
							...
							:class="{ ' active': departmentOfPastoralMusicIndex == 0 }"
							:id="'above_' + departmentOfPastoralMusicIndex + '-tab'"
							role="tabpanel"
							:aria-labelledby="
								'above_' + departmentOfPastoralMusicIndex
							"
							:key="
