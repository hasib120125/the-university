        ...
        <div>
			<ul class="nav nav-tabs" id="myTab" role="tablist" >
				<li class="nav-item" role="presentation" v-for="(academicRegulation , academicRegulationIndex) in academicRegulations" :key="'academic-regulation' + academicRegulationIndex">
					<a class="nav-link" :class="{' active' : academicRegulationIndex == 0}" :id="'above_' + academicRegulationIndex" data-toggle="tab" 
						:href="'#above_' + academicRegulationIndex +'-tab'" role="tab" :aria-controls="'above_' + academicRegulationIndex"
			...
			<div class="tab-content" id="myTabContent">
				<template v-for="(academicRegulation , academicRegulationIndex) in academicRegulations">
					<div class="tab-pane fade show" :class="{' active' : academicRegulationIndex == 0}" :id="'above_' + academicRegulationIndex + '-tab'" role="tabpanel"
					 :aria-labelledby="'above_' + academicRegulationIndex"  :key="'academic-regulation' + academicRegulationIndex">
